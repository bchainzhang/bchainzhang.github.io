...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    Email: haibin at bit dot edu dot cn<br>
  </div>
</div>
...
- Sisi Duan and Haibin Zhang. Recent Progress on BFT in the era of Blockchains. Nature Science Review (NSR). (This is an invited, peer-reviewed perspective which is asked to describe our own work on BFT. The maximum number of papers that the perspective can cite is 10. So the perspective only a selected number of papers and many papers end up with no citations (sorry!). If you are interested in a comprehensive survey, say the paper below.)
