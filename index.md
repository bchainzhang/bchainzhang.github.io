...
- Chao Yin, Haihong Tian, Chenglu Jin, Zheng Yang, Haibin Zhang, and Fabio Massacci. 
  CRSF: Collusion-Resilient Privacy-Preserving Sensor Fusion with Byzantine-Robust Participation. ISC 2026. 
-  Xuyang Liu, Zijian Zhang, Haibin Zhang, Jiamou Liu, Meng Li, Zhen Li, Mengmeng Zhou, Wei Shen, Peng Jiang, Cong Guo, and Liehuang Zhu. ROPSCON: Linear BFT From Schnorr Threshold Signatures. IEEE Transactions on Computers, 2026. 
